  ...
  <el-card class="box-card">
    ...
    <el-row>
      <el-col :span="24" class="searchArea">
        <el-button plain type="success" @click="addGoodsCate()">添加分类</el-button>
      </el-col>
    </el-row>
    ...
    <el-table height="400" :data="list" style="width: 100%">
      ...
      expandAll->默认全展开
      -->
      <el-tree-grid prop="cat_name" treeKey="cat_id" parentKey="cat_pid" levelKey="cat_level" childKey="children" label="商品分类" width="200">
      </el-tree-grid>
